...
Config.DefaultConfig                                     = {
    ...
    ['RezRange']                   = {
        DisplayName = "Rez Range",
        Group = "Abilities",
        Header = "Recovery",
        Category = "Rezzing",
        Index = 4,
        Tooltip = "Horizontal radius (in units) to search for PC corpses to rez.",
        Default = 100,
        Min = 10,
        Max = 300,
        ConfigType = "Advanced",
    ...
    ['RezMode']                    = {
        DisplayName = "Rez Mode",
        Group = "Abilities",
        Header = "Recovery",
        Category = "Rezzing",
        Index = 8,
        Tooltip = "Heal First: rez after the heal rotation (default). Rez First: rez before heals, heals only fire at the emergency HP threshold. Timed Interrupt: heals run normally, but a rez check is forced every N seconds.",
        Type = "Combo",
        ComboOptions = { "Heal First", "Rez First", "Timed Interrupt", },
        Default = 1,
        Min = 1,
        Max = 3,
        ConfigType = "Advanced",
    ...
    ['RezModeHealPct']             = {
        DisplayName = "Rez Mode Emergency Heal %",
        Group = "Abilities",
        Header = "Recovery",
        Category = "Rezzing",
        Index = 9,
        Tooltip = "HP% at which heals fire when Rez Mode is set to Rez First. Lower values mean you heal less often while rezzing.",
        Default = 30,
        Min = 5,
        Max = 95,
        ConfigType = "Advanced",
    },
    ['RezInterruptInterval']       = {
        DisplayName = "Rez Interrupt Interval",
        Group = "Abilities",
        Header = "Recovery",
        Category = "Rezzing",
        Index = 10,
        Tooltip = "Seconds between forced rez checks when Rez Mode is set to Timed Interrupt.",
        Default = 30,
        Min = 5,
        Max = 300,
        ConfigType = "Advanced",
    ...
    ['RezPriorityNames']           = {
        DisplayName = "Rez Priority Names",
        Group = "Abilities",
        Header = "Recovery",
        Category = "Rezzing",
        Index = 11,
        Tooltip = "Character names to always rez before anyone else, in order listed. Overrides Rez Role Priority.",
        Type = "Custom",
        Default = {},
        ConfigType = "Advanced",
    },
    ['RezBlockList']               = {
        DisplayName = "Rez Block List",
        Group = "Abilities",
        Header = "Recovery",
        Category = "Rezzing",
        Index = 14,
        Tooltip = "Character names to never rez.",
        Type = "Custom",
        Default = {},
        ConfigType = "Advanced",
    },
    ['RezSkipClasses']             = {
        DisplayName = "Rez Skip Classes",
        Group = "Abilities",
        Header = "Recovery",
        Category = "Rezzing",
        Index = 15,
        Tooltip = "Class short names to never rez (e.g. NEC to skip necromancers).",
        Type = "Custom",
        Default = {},
        ConfigType = "Advanced",
    },
    ['UseRezPriorityNames']        = {
        DisplayName = "Use Rez Priority Names",
        Group = "Abilities",
        Header = "Recovery",
        Category = "Rezzing",
        Index = 16,
        Tooltip = "Enable named rez priority. When enabled, characters in the Rez Priority Names list are rezzed before all others.",
        Default = true,
        ConfigType = "Advanced",
    },
    ['UseRezBlockList']            = {
        DisplayName = "Use Rez Block List",
        Group = "Abilities",
        Header = "Recovery",
        Category = "Rezzing",
        Index = 19,
        Tooltip = "Enable the rez block list. When enabled, characters in the list will never be rezzed.",
        Default = true,
        ConfigType = "Advanced",
    },
    ['UseRezSkipClasses']          = {
        DisplayName = "Use Rez Skip Classes",
        Group = "Abilities",
        Header = "Recovery",
        Category = "Rezzing",
        Index = 20,
        Tooltip = "Enable the rez skip classes list. When enabled, classes in the list will never be rezzed.",
        Default = true,
        ConfigType = "Advanced",
    },
